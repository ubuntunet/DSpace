        ...
        <head>
            ...
            <meta name="Generator">
                <xsl:attribute name="content">
                    <xsl:text>UbuntuNet Alliance</xsl:text>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-4 hidden-print">
                        <div class="pull-right">
                            <span class="theme-by">Operated by&#160;</span>
                            <br/>
                            <a title="UbuntuNet Alliance" target="_blank" href="https://ubuntunet.net">
                                <img alt="UbuntuNet Alliance" src="{concat($theme-path, 'images/ua-logo_138x36.png)}"/>
                            </a>
                        </div>
